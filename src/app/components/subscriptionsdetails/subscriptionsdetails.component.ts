...
@Component({
  selector: 'app-subscriptionsdetails',
  templateUrl: './subscriptionsdetails.component.html',
  styleUrls: ['./subscriptionsdetails.component.css']
})
export class SubscriptionsdetailsComponent implements OnInit {
  ...
  displayedColumns: any = [
    ...
    {"name":"Advertise Plan", "key" : "planIdAdvertiseName"},
  ...
  broadCastMessage(): void {
    this.messageService.broadCastMessage("Subscriptions Details");
 }
